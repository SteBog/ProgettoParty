...
<%
	...
	int vittorie = listVittorie.selectVittorie(request.getSession().getAttribute("Utente").toString());
...
<html>
	...
	<body>
		...
		<span>Partite vinte: <%=vittorie %></span>
	<%
		for(qVittorieMinigiochiBean vittoria:vittorieMinigiochi)
		{
			int VittorieMinigiochi = vittoria.getVittorieMinigiochi();
			String Minigiochi = vittoria.getMinigioco();
